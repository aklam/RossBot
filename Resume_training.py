...
nmt_model = TranslationModel(params, 
    ...
    weights_path='trained_models/2LayerGRU/epoch_20_init.h5',
    model_name='Dec_27',
    vocabularies=ds.vocabulary,
    store_path='trained_models/2LayerGRU_100/',
    verbose=True)
...
training_params = {'n_epochs': 100, 'batch_size': 20,'maxlen': 30, 'epochs_for_save': 4, 'verbose': 1, 'eval_on_sets': [], 'reload_epoch': 20, 'epoch_offset': 20}
